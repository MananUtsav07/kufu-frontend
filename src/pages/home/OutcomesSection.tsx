...
const features = [
  {
    ...
    description: "Kufu can crawl your website and train your chatbot from your existing content with minimal manual setup.",
    accent: "#3b82f6",
  ...
  },
  {
    ...
    description: "Add one script tag to your website and launch your AI chatbot quickly with a simple embed flow.",
    accent: "#8b5cf6",
  ...
  },
  {
    ...
    description: "When your content changes, you can update your knowledge and run a fresh sync from the dashboard.",
    accent: "#06b6d4",
  ...
  },
  {
    ...
    description: "Tune your chatbot name, greeting, and knowledge so replies stay aligned with your business voice.",
    accent: "#3b82f6",
    border: "rgba(59,130,246,0.18)",
    glow: "rgba(59,130,246,0.06)",
  },
