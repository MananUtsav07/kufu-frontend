        ...
        <div className="w-full max-w-[400px]">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {error && (
                <div
                  className="rounded-xl px-4 py-3 text-sm text-red-300 flex flex-col gap-2"
                  style={{
                ...
                >
                  ...
                  {error === 'Email not verified' && (
                    <Link
                      ...
                      className="text-indigo-400 hover:text-indigo-300 text-xs underline underline-offset-2 ml-[22px] transition-colors duration-200"
                    >
